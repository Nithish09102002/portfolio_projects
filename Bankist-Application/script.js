...
const account1 = {
  ...
  movementsDates: [
    ...
    '2024-02-07T17:01:17.194Z',
    '2024-02-08T23:36:17.929Z',
...
const formatDate = function (date) {
  ...
  const daypassed = days(new Date(), date);
...
const displayMovements = function (acc, sort = false) {
  ...
  movs.forEach(function (mov, i) {
    ...
    const displayCur = formatedCur(mov, acc.locale, acc.currency);
    const html = `
