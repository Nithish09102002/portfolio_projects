...
// message.innerHTML = `clear cookies in the web page to get extra storage<button class="btn cookies-btn">Got it</button>`;
// message.style.width = '120%';
// message.style.height = '80px';
// header.prepend(message);

// const btnCookie = document.querySelector('.cookies-btn');
...
document.querySelector('.nav').addEventListener('mouseover', handler.bind(0.5));

document.querySelector('.nav').addEventListener('mouseout', handler.bind(1));
...
const revealImg = function (entries, observe) {
  const [entry] = entries;
...
const imageObs = new IntersectionObserver(revealImg, {
  root: null,
  threshold: 0,
  rootMargin: '200px',
});
